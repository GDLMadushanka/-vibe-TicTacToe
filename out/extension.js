...
class TicTacToeViewProvider {
    static viewType = 'tictactoe.gameView';
    resolveWebviewView(webviewView, _context, _token) {
        ...
        webviewView.webview.onDidReceiveMessage((message) => {
            if (message.type === 'gameOver' && message.payload) {
                ...
                const text = w === 'X' ? '🎉 You win! Congratulations!' :
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider(TicTacToeViewProvider.viewType, provider, { webviewOptions: { retainContextWhenHidden: true } }));
}
function deactivate() { }
// ---------------------------------------------------------------------------
// Webview content
